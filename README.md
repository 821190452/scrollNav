...
for auto generating single page navigation with highlighting based on the
user's scroll location. Useful for creating a Table of Contents for
a large document (think Wikis), navigation for a single page website, or
